...
| <a name="input_flux_slack_channel"></a> [flux\_slack\_channel](#input\_flux\_slack\_channel) | Slack channel ID the bot-token Flux notifications post to. Required alongside flux\_slack\_bot\_token. | `string` | `""` | no |
