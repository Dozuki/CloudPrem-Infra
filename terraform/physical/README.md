...
| <a name="input_dms_allocated_storage"></a> [dms\_allocated\_storage](#input\_dms\_allocated\_storage) | n/a | `string` | `100` | no |
| <a name="input_dms_instance_type"></a> [dms\_instance\_type](#input\_dms\_instance\_type) | n/a | `string` | `"dms.r5.large"` | no |
