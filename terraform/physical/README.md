...
| <a name="input_slack_channel_id"></a> [slack\_channel\_id](#input\_slack\_channel\_id) | Slack channel ID the bot-token alerts post to. Required alongside slack\_bot\_token. | `string` | `""` | no |
