...
func Test_UsEast1_BI_VPN(t *testing.T) {
	t.Parallel()
	...
	var environment = "bi"
	var physConfig = testCommon.BIVPNPhysConfig
	var logiConfig = testCommon.BIVPNLogiConfig
	var prefixConfig = testCommon.VPNPrefixConfig
